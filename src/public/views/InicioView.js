...
const VIEW_CONTENT = `
    ...
    <header class="header">
        ...
        <div class="menu container">
            ...
            <label for="menu">
                <img src="frontend/images/menu.png" class="menu-icono" alt="menu">
            </label>
            <nav class="navbar">
                <ul>
    ...
    <section class="cake">
        ...
        <div class="cake-contact container">
            ...
            <div class="cake-group">
                <div class="cake-1">
                    <img src="frontend/images/postre1.avif" alt="torta selva negra">
                ...
                <div class="cake-1">
                    <img src="frontend/images/postre2.avif" alt="chessecake">
                ...
                <div class="cake-1">
                    <img src="frontend/images/postre3.avif" alt="brownie">
        ...
        <div class="services-content container">
            ...
            <div class="services-group">
                <div class="services-1">
                    <img src="frontend/images/servicio1.avif" alt="s1">
                ...
                <div class="services-1">
                    <img src="frontend/images/servicio2.avif" alt="s1">
                ...
                <div class="services-1">
                    <img src="frontend/images/servicio3.avif" alt="s1">
    ...
    <section class="productos" id="productos">
        ...
        <div class="blog-content container">
            <div class="blog-1">
                <img src="frontend/images/torta-clasica.avif" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/torta-manzana.avif" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/torta-oreo.jpg" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/choco-torta.jpg" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/tarta-coco.jpg" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/tarta-frutilla.jpg" alt="">
            ...
            <div class="blog-1">
                <img src="frontend/images/tarta-toffe.jpg" alt="">
    ...
    <footer class="footer" id="contacto">
        <div class="footer-content container">
            <div class="medios-pago">
                ...
                <ul>
                    <li><img src="frontend/images/transferencias.png" alt="transferencias" class="icon">Transferencias</li>
                    <li><img src="frontend/images/tarjeta-credito.png" alt="tarjeta-credito" class="icon">Tarjeta de crédito</li>
                    <li><img src="frontend/images/tarjeta-debito.png" alt="tarjeta-debito" class="icon">Tarjeta de débito</li>
                    <li><img src="frontend/images/efectivo.png" alt="efectivo" class="icon">Efectivo</li>
            </div>
            <div class="contacto">
                <h3 class="title-3">Contacto</h3>
                <ul>
                    <li><img src="frontend/images/whatsapp_3536445.png" alt="whatsapp" class="icon"><a href="https://api.whatsapp.com/send?phone=1168068390&text=Hola%20como%20estas%20%3F'">Celular: 11 54 65 78 12</a></li>
                    <li><img src="frontend/images/instagram.png" alt="instagram" class="icon"><a href="https://www.instagram.com/comiendoconpipi/">Instagram: comiendoconpipi</a></li>
                    <li><img src="frontend/images/facebook.png" alt="facebook" class="icon"><a href="https://www.facebook.com/luanaelverdi/">Facebook: comiendoconpipi</a></li>
                    <li><img src="frontend/images/correo.png" alt="correo" class="icon"><a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=luanaelverdi@gmail.com">Correo: comiendoconpipi@gmail.com</a></li>
                </ul>
            </div>
        </div>
    </footer>
